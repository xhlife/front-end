...
![原型](https://github.com/xhlife/front-end/blob/master/js基础/数据类型/images/proto.png)
+ 原型指向 
上面提到有三种方式创建对象
1. 字面量方式指向
![直接字面量原型指向](https://github.com/xhlife/front-end/blob/master/js基础/数据类型/images/proto_1.png)
2. new 方式 （构造函数方式）
![构造函数方式原型指向](https://github.com/xhlife/front-end/blob/master/js基础/数据类型/images/proto_2.png)
...
```
![构造函数方式原型指向](https://github.com/xhlife/front-end/blob/master/js基础/数据类型/images/proto_3.png)
> 原型链
...
var a = new A();
```
![构造函数方式原型指向](https://github.com/xhlife/front-end/blob/master/js基础/数据类型/images/proto_chain.png)
+ 可扩展性
